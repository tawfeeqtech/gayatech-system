...
const DangerZone = ({ resetting, onReset }) => (
  ...
  >
    <Alert
      ...
      description="سيتم مسح: المعاملات، الفواتير، العقود، المشاريع، العملاء، الموظفين، الرواتب، الموردين، الاشتراكات، وغيرها. سيتم تصفير أرصدة المحافظ فقط (0)."
      type="error"
      showIcon
      ...
      <Col xs={24} sm={12}>
        <Statistic
          title="المحتفظ به"
          value="المستخدمين • الحسابات • المحافظ (برصيد 0) • العملات"
